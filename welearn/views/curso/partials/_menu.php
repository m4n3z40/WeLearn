...
<ul>
    ...
    <li><?php echo anchor('/curso/meus_cursos_aluno/', 'Cursos em que sou Aluno') ?></li>
    <li><?php echo anchor('/curso/meus_cursos_em_espera', 'Inscrições em Espera') ?></li>
    <li><?php echo anchor('/curso/meus_convites/', 'Convites de Curso') ?></li>
    <li><?php echo anchor('/curso/meus_certificados/', 'Meus Certificados') ?></li>
</ul>