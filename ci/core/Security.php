...
class CI_Security {
	...
	public function __construct()
	{
		...
		$this->_csrf_cookie_name = (config_item('csrf_cookie_name')) ? config_item('csrf_cookie_name') : $this->_csrf_cookie_name;
        $this->_csrf_token_name = (config_item('csrf_token_name')) ? config_item('csrf_token_name') : $this->_csrf_token_name;
        $this->_csrf_expire = (config_item('csrf_expire')) ? config_item('csrf_expire') : $this->_csrf_expire;
